...
namespace SuperSaiyan
{
    ...
    public static class CollisionUtils
    {
        ...
        public static EnemiesCollisionSide GetCollisionSide(Rectangle rectangle, Rectangle collisionRectangle,
            Vector2 firstVelocity, Vector2 secondVelocity)
        {
            List<EnemiesCollisionSide> collisionSides = GetCollisionSides(rectangle, collisionRectangle);
            ...
            else if (collisionSides.Count == 2)
            {
                ...
                EnemiesCollisionSide topBottomCollisionSide;
                if (collisionSides.Contains(EnemiesCollisionSide.Top))
                {
                    topBottomCollisionSide = EnemiesCollisionSide.Top;
                }
                else
                {
                    topBottomCollisionSide = EnemiesCollisionSide.Bottom;
                }
                EnemiesCollisionSide leftRightCollisionSide;
                if (collisionSides.Contains(EnemiesCollisionSide.Left))
                {
                ...
                if (yRatio < xRatio)
                {
                    ...
                    if ((velocityRelativeY < 0 && topBottomCollisionSide == EnemiesCollisionSide.Top) ||
                        (velocityRelativeY > 0 && topBottomCollisionSide == EnemiesCollisionSide.Bottom))
                    {
                ...
                else
                {
                    ...
                    if ((velocityRelativeX < 0 && leftRightCollisionSide == EnemiesCollisionSide.Left) ||
                        (velocityRelativeX > 0 && leftRightCollisionSide == EnemiesCollisionSide.Right))
                    {
            ...
            else
            {
                ...
                if (collisionSides.Contains(EnemiesCollisionSide.Top) &&
                    collisionSides.Contains(EnemiesCollisionSide.Bottom))
                {
                    if (collisionSides.Contains(EnemiesCollisionSide.Left))
                    {
        ...
        private static List<EnemiesCollisionSide> GetCollisionSides(Rectangle rectangle, Rectangle collisionRectangle)
        {
            List<EnemiesCollisionSide> collisionSides = new List<EnemiesCollisionSide>();
            if (collisionRectangle.Left == rectangle.Left)
            {
                collisionSides.Add(EnemiesCollisionSide.Left);
            }
            if (collisionRectangle.Right == rectangle.Right)
            {
                collisionSides.Add(EnemiesCollisionSide.Right);
            }
            if (collisionRectangle.Top == rectangle.Top)
            {
                collisionSides.Add(EnemiesCollisionSide.Top);
            }
            if (collisionRectangle.Bottom == rectangle.Bottom)
            {
                collisionSides.Add(EnemiesCollisionSide.Bottom);
            }
        ...
        private static Vector2 GetSideCollisionNormal(EnemiesCollisionSide side)
        {
            switch (side)
            {
